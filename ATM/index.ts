...
let Total_Balance: number = 10000;
...
if (pinAnswer.pin === myPin) {
  ...
  if (operation.Operations === "withdraw") {
    ...
    if (
      ...
      console.log(
        chalk.magentaBright(
          `Successfully withdraw the amount of : ${chalk.yellowBright(
            amount_for_withdrawal.withdraw
          )} $`
        )
      );
      console.log(
        chalk.magentaBright(
          `The remaining balance is : ${chalk.yellowBright(
    ...
    console.log(
      chalk.magentaBright(
        `The balance of your account is : ${chalk.yellowBright(Total_Balance)}$`
      )
    );
    ...
    console.log(
      chalk.magentaBright(
        `The remaining balance is : ${chalk.yellowBright(
          Total_Balance - fast_cash.fast_cash1
        )}$`
      )
    );
